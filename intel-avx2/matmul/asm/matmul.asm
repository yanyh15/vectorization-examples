...
# mark_description "-o asm/matmul.asm -O2 -no-vec -S -masm=intel";
...
..B1.36:                        # Preds ..B1.1
                                # Execution count [1.00e+00]
        stmxcsr   DWORD PTR [rsp]                               #47.34
        mov       edi, 1048576                                  #48.16
        or        DWORD PTR [rsp], 32832                        #47.34
        ldmxcsr   DWORD PTR [rsp]                               #47.34
#       malloc(size_t)
        call      malloc                                        #48.16
                                # LOE rax r12 r13
..B1.35:                        # Preds ..B1.36
...
..B1.9:                         # Preds ..B1.8
                                # Execution count [2.62e+05]
        pxor      xmm0, xmm0                                    #54.5
        cvtsi2ss  xmm0, eax                                     #54.5
        divss     xmm0, DWORD PTR .L_2il0floatpacket.0[rip]     #54.5
        movss     DWORD PTR [r12+r15*4], xmm0                   #54.5
        inc       r15                                           #54.5
        cmp       r15, 512                                      #54.5
...
..B1.14:                        # Preds ..B1.13
                                # Execution count [2.62e+05]
        pxor      xmm0, xmm0                                    #55.5
        cvtsi2ss  xmm0, eax                                     #55.5
        divss     xmm0, DWORD PTR .L_2il0floatpacket.0[rip]     #55.5
        movss     DWORD PTR [r12+r14*4], xmm0                   #55.5
        inc       r14                                           #55.5
        cmp       r14, 512                                      #55.5
...
..B1.17:                        # Preds ..B1.16
        ...
        pxor      xmm0, xmm0                                    #60.22
        pxor      xmm1, xmm1                                    #60.22
        movzx     eax, WORD PTR [8+rsp]                         #60.22
        xor       r11b, r11b                                    #61.10
        cvtsi2sd  xmm0, eax                                     #60.22
        cvtsi2sd  xmm1, QWORD PTR [rsp]                         #60.22
        divsd     xmm0, QWORD PTR .L_2il0floatpacket.1[rip]     #60.22
        xor       eax, eax                                      #61.10
        addsd     xmm1, xmm0                                    #60.22
        movsd     QWORD PTR [32+rsp], xmm1                      #60.22[spill]
...
..B1.21:                        # Preds ..B1.21 ..B1.20
        ...
        mov       r13d, r9d                                     #62.6
        shl       r13d, 9                                       #62.6
        movss     xmm0, DWORD PTR [r10+r9*4]                    #62.6
        inc       r9                                            #62.6
        mulss     xmm0, DWORD PTR [rdx+r13*4]                   #62.6
        movss     xmm1, DWORD PTR [48+rsp]                      #62.6
        addss     xmm1, xmm0                                    #62.6
        movss     DWORD PTR [48+rsp], xmm1                      #62.6
        cmp       r9, 512                                       #62.6
...
..B1.26:                        # Preds ..B1.25
                                # Execution count [1.00e+00]
        pxor      xmm0, xmm0                                    #64.16
        pxor      xmm1, xmm1                                    #64.16
        movzx     eax, WORD PTR [24+rsp]                        #64.16
        mov       edi, offset flat: il0_peep_printf_format_0    #69.5
        cvtsi2sd  xmm0, eax                                     #64.16
        cvtsi2sd  xmm1, QWORD PTR [16+rsp]                      #64.16
        divsd     xmm0, QWORD PTR .L_2il0floatpacket.1[rip]     #64.16
        addsd     xmm1, xmm0                                    #64.16
        subsd     xmm1, QWORD PTR [32+rsp]                      #64.31[spill]
        movsd     QWORD PTR [40+rsp], xmm1                      #64.31[spill]
        call      puts                                          #69.5
                                # LOE r12 r13
..B1.27:                        # Preds ..B1.26
                                # Execution count [1.00e+00]
...
..B1.31:                        # Preds ..B1.30
                                # Execution count [1.00e+00]
        movsd     xmm2, QWORD PTR .L_2il0floatpacket.3[rip]     #74.5
        mov       edi, offset flat: .L_2__STRING.4              #74.5
        movsd     xmm0, QWORD PTR [40+rsp]                      #74.5[spill]
        mov       eax, 2                                        #74.5
        mulsd     xmm2, xmm0                                    #74.5
        movsd     xmm1, QWORD PTR .L_2il0floatpacket.2[rip]     #74.5
        divsd     xmm1, xmm2                                    #74.5
...
..B2.2:                         # Preds ..B2.1
                                # Execution count [1.00e+00]
        pxor      xmm1, xmm1                                    #19.40
        pxor      xmm0, xmm0                                    #19.21
        movzx     eax, WORD PTR [8+rsp]                         #19.40
        cvtsi2sd  xmm1, eax                                     #19.40
        cvtsi2sd  xmm0, QWORD PTR [rsp]                         #19.21
        divsd     xmm1, QWORD PTR .L_2il0floatpacket.1[rip]     #19.53
        addsd     xmm0, xmm1                                    #19.53
        add       rsp, 24                                       #19.53
...
..B3.4:                         # Preds ..B3.4 ..B3.3
        ...
        mov       r15d, r10d                                    #40.17
        shl       r15d, 9                                       #40.47
        movss     xmm0, DWORD PTR [r11+r10*4]                   #40.26
        inc       r10                                           #39.32
        mulss     xmm0, DWORD PTR [rbx+r15*4]                   #40.41
        movss     xmm1, DWORD PTR [-16+rsp]                     #40.17
        addss     xmm1, xmm0                                    #40.17
        movss     DWORD PTR [-16+rsp], xmm1                     #40.17
        cmp       r10, 512                                      #39.29
...
..B4.4:                         # Preds ..B4.3
                                # Execution count [2.62e+05]
        pxor      xmm0, xmm0                                    #26.31
        cvtsi2ss  xmm0, eax                                     #26.31
        divss     xmm0, DWORD PTR .L_2il0floatpacket.0[rip]     #26.38
        movss     DWORD PTR [r13+r15*4], xmm0                   #26.13
        inc       r15                                           #25.28
        cmp       r15, 512                                      #25.25
